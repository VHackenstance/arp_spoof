...
# packet.show() will show us the MAC Address of the router hwsrc is now our MAC.
# packet.summary() provides similar information: ARP is at [OUR_MAC_ADDRESS] says [ROUTER_IP]
print(packet.show())
